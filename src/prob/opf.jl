...
function solve_opf_with_inertia(file, model_type::Type, optimizer, options::Dict{String, Dict{String}}; kwargs...)
...
function solve_mn_opf_with_inertia_and_generator_expansion(file, model_type::Type, optimizer, options::Dict{String, Dict{String}}; kwargs...)
    ...
    return solve_mn_opf_inertia_gen_exp(file, model_type, optimizer, options; kwargs...)
end
...
function build_mn_opf_inertia_gen_exp(model_type::Type, options::Dict{String, Dict{String}})
    ...
    return build_my_mn_opf_inertia_gen_exp
end
