...
mpc.bus = [
	1	 2	 50.0	 40.0	 0.0	 0.0	 1	    1.10000	   -0.00000	 240.0	 1	    1.10000	    0.90000;
	2	 2	 50.0	 40.0	 0.0	 0.0	 1	    0.92617	    7.25883	 240.0	 1	    1.10000	    0.90000;
	3	 2	 50.0	 50.0	 0.0	 0.0	 1	    0.90000	  -17.26710	 240.0	 2	    1.10000	    0.90000;
];

%	bus	Pg		Qg		 Qmax	  Qmin	 Vg		 mBase	status	Pmax  Pmin	H
mpc.gen = [
	1	 158.067	 28.79	 1000.0	 -1000.0	 1.1	 	100.0	 1	 2000.0	 0.0	 5.0;
	2	 160.006	-4.63	 1000.0	 -1000.0	 0.92617	 100.0	 1	 1500.0	 0.0	 10.0;
	3	 0.0	 	-4.843	 1000.0	 -1000.0	 0.9	 	100.0	 1	 1000.0	 0.0	 7.0;
];

mpc.gencost = [
	2	 0.0	 0.0	 3	   1.0000	   3.000000	   0.000000;
	2	 0.0	 0.0	 3	   4.085000	   7.000000	   0.000000;
	2	 0.0	 0.0	 3	   2.000000	   5.000000	   0.000000;
];
