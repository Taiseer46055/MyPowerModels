...
@testset "test ac tnep" begin
    ...
    @testset "5-bus case" begin
        result = solve_tnep("../test/data/matpower/case5_tnep.m", ACPPowerModel, minlp_solver)
...
@testset "test soc tnep" begin
    ...
    @testset "5-bus rts case" begin
        result = solve_tnep("../test/data/matpower/case5_tnep.m", SOCWRPowerModel, minlp_solver)
...
#     @testset "5-bus rts case" begin
#         result = solve_tnep("../test/data/matpower/case5_tnep.m", QCRMPowerModel, minlp_solver)
...
@testset "test dc tnep" begin
    ...
    @testset "5-bus case" begin
        result = solve_tnep("../test/data/matpower/case5_tnep.m", DCPPowerModel, minlp_solver)
...
@testset "test matpower dc tnep" begin
    @testset "5-bus case with matpower DCMP model and TNEP" begin
        result = solve_tnep("../test/data/matpower/case5_tnep.m", DCMPPowerModel, minlp_solver)
...
@testset "test lpac tnep" begin
    ...
    @testset "5-bus case" begin
        result = solve_tnep("../test/data/matpower/case5_tnep.m", LPACCPowerModel, minlp_solver)
